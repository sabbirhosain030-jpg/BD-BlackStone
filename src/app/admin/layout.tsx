        ...
        <div className="admin-container">
            <aside className="admin-sidebar">
                ...
                <nav className="admin-nav">
                    ...
                    <Link href="/admin/subscribers" className="admin-nav-item">
                        <svg className="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link href="/admin/homepage-banners" className="admin-nav-item">
                        <svg className="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link href="/admin/site-settings" className="admin-nav-item">
                        <svg className="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link href="/admin/popup-settings" className="admin-nav-item">
                        <svg className="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link href="/admin/footer-links" className="admin-nav-item">
                        <svg className="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
